...
# Tool Pages for Generating Software Tests {#sec-tool-pages}
...
![BASFuzz Workflow](/img/BASFuzz_Workflow.png){.lightbox}
...
![Example of Robustness Flaw found by BASFuzz](/img/BASFuzz_fig1.png){.lightbox}
...
![LLMorph workflow](/img/LLM-MorphFig1.png){.lightbox}
